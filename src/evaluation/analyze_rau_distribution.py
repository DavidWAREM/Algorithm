...
def load_and_analyze_rau_values(directory, num_valves=100):
    ...
    for i in range(1, num_valves + 1):
        edge_file = os.path.join(directory, f'SyntheticData-Spechbach_Simplification^3(0;0.1)_Roughness_{i}_combined_Pipes.csv')
...
def main():
    ...
    directory = 'C:\\Users\\D.Muehlfeld\\Documents\Synthetic_Data\\Synthetic_Data_Roughness_Simplification^3(0;0.1)\\Zwischenspeicher'  # Pfad zu deinen Daten anpassen
